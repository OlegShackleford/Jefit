...
public class RoutineDatabasePage {
    ...
    private final static String MOST_VIEWED_OPTION = "//button[normalize-space() = 'Most Viewed']";
    private final static String FIRST_PLAN_IN_LIST = "//table[@class = 'min-w-full text-left text-sm/6']" +
