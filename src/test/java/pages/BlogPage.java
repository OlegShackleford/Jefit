...
public class BlogPage {
    private static String LINK = "https://www.jefit.com/blog/";
    private static String POPULAR_POST = "//div[@class ='ss-popular-posts-widget ss-clearfix" +
            " ss-circle-thumb ss-thumbnail-thumb']/descendant::a[@data-ranking = '1. ']";
    private static String TITLE = "//h2[@class = 'widget-title' and text() = 'Popular Posts']";
